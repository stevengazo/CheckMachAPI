...
namespace CheckMachAPI.Migrations
{
    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TimePeerProjects",
                columns: table => new
                {
                    TimePeerProjectId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimePeerProjects", x => x.TimePeerProjectId);
                    table.ForeignKey(
                        name: "FK_TimePeerProjects_Machines_MachineId",
                        column: x => x.MachineId,
                        principalTable: "Machines",
                        principalColumn: "MachineId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimePeerProjects_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryMoveId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryMoves", x => x.InventoryMoveId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMoves_InventoryItemId",
                table: "InventoryMoves",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryMoves_UserId",
                table: "InventoryMoves",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimePeerProjects_MachineId",
                table: "TimePeerProjects",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_TimePeerProjects_ProjectId",
                table: "TimePeerProjects",
                column: "ProjectId");
        }
